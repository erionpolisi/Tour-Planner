...
export class DashboardComponent {
  ...
  protected readonly tourLogService = inject(TourLogService);
  protected readonly icons = { Map, ScrollText, TrendingUp, Star, Activity, Users, ArrowRight, MapPin, Clock };
  ...
  protected readonly topTours = computed(() => {
